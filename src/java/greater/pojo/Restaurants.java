...
public class Restaurants  implements java.io.Serializable {
    ...
    public Restaurants(String id) {
        this.id = id;
    }
    public Restaurants(String id, Guests guests, RestaurantPriceLists restaurantPriceLists, String walkInGuestId, String receiptNo, String roomNo, String tableNo, Integer qty, String mealType, Double amount, Double discountedRate, Double total, Double vat5, Double conTax5, String waiterName, String guestSignature, String signture, String authorizedDiscount, String approvedDiscount, String times, String createdDate) {
       this.id = id;
       this.guests = guests;
    ...
    public RestaurantPriceLists getRestaurantPriceLists() {
        return this.restaurantPriceLists;
    }
